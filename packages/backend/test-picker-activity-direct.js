...
async function testPickerActivity() {
  try {
    console.log('=== TESTING PICKER ACTIVITY ===\n');
    ...
    if (activePickers.rows.length === 0) {
      console.log('No pickers found, exiting.');
      return;
    }
    ...
    console.log('Step 3 - Final picker activity result:');
    console.log('  Count:', result.length);
    console.log('  Data:', JSON.stringify(result, null, 2));
    console.log('');
    console.log('=== CHECKING FOR pickerId IN EACH ENTRY ===');
    result.forEach((picker, index) => {
      console.log(`Picker ${index + 1}:`);
      console.log('  pickerId:', picker.pickerId);
